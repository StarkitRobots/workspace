...
- Faire masque à l'oeil et adapter en faisant tourner sift en fake
  - mettre les images (pano et masque) dans common, et mettre dans workspace/src/starkit/kid_size/Vision/Filters/Features/VisualCompass.cpp les bonnes image dans updateField()
